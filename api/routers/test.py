...
def _profile_override_content(profile: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        _env_line("OCPP_AUTH_TYPE", (profile.get("auth_type") or "basic")),
        ...
        _env_line("OCPP_PASSWORD_ENV_VAR", (profile.get("password_env_var") or "")),
        _env_line("OCPP_MTLS_CERT_PATH", (profile.get("mtls_cert_path") or "")),
        _env_line("OCPP_MTLS_KEY_PATH", (profile.get("mtls_key_path") or "")),
        _env_line("OCPP_MTLS_CA_PATH", (profile.get("mtls_ca_path") or "")),
