...
**Son Değiştirilme Tarihi:** 2025-12-08 16:02:06  
**Version:** 1.2.0  
...
1. **Şarj Başlatma**
   - Komut: Authorization (01)
   - Değer: 01
   - Hex: `41 01 2C 01 10`

2. **Durum Bilgisi Alma**
   - Komut: Status (00)
   - Değer: 00
   - Hex: `41 00 2C 00 10`

3. **Şarjı Sonlandırma**
   - Komut: State Machine (04)
   - Değer: 07 (Finishing)
   - Hex: `41 04 2C 07 10`

4. **Akım Değiştirme/Set Etme**
   - Komut: Akım Set (02)
   - Değer: 06, 0A, 0D, 10, 14, 19, 20 (6A-32A)
   - Hex: `41 02 2C [DEĞER] 10`
   - **ÖNEMLİ:** Bu işlem şarj esnasında olmayacaktır. Sadece aktif şarj başlamadan akım değiştirilebilir/set edilebilir (güvenlik nedeniyle)
