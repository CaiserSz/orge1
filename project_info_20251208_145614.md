...
**Son Değiştirilme Tarihi:** 2025-12-08 17:14:30  
**Version:** 1.3.5  
...
#### Dışarıdan Erişim
- **HTTP/HTTPS:** `https://lixhium.ngrok.app` adresinden RPi'deki port 8000'e erişilebilir
- **TCP:** `9.tcp.eu.ngrok.io:29229` adresinden RPi'deki port 29229'e erişilebilir
