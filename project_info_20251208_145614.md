...
**Son Değiştirilme Tarihi:** 2025-12-08 18:35:00  
**Version:** 1.4.2  
...
6. **POST /api/maxcurrent** - Maksimum akım ayarlama
   ...
   - Request Body: `{"amperage": 16}` (6, 10, 13, 16, 20, 25, 32)
   - Güvenlik: Şarj aktifken akım değiştirilemez

7. **GET /api/current/available** - Kullanılabilir akım değerleri
   - ESP32'de ayarlanabilir tüm akım değerlerini listeler
   - Response: `{"available_amperages": [6, 10, 13, 16, 20, 25, 32], "recommended": 16}`
