...
**Son Değiştirilme Tarihi:** 2025-12-08 18:20:00  
**Version:** 1.4.1  
...
6. **POST /api/current/set** - Akım ayarlama
...
- **Güncelleme:** Görevler tamamlandıkça `master_done.md`'ye taşınır, aktif görevler `master_live.md`'ye eklenir
